...
export const projects = [
...

  {
    ...
    role: "Senior Full-Stack Developer",
    responsibilities: `	
	- Working as a part of scrum team implementing new functionality using Sharepoint Online <br>
  - Implementing POC web app using cutting edge technologies on top of Sharepoint Online <br>
`,
    team: "10 team members",
    techStack:
...

  {
    ...
    responsibilities: `	
- pre-sales phase, project estimation <br> 
- project architecture design and development <br> 
- leading and mentoring junior developer <br>
`,
    team: "3 team members",
    techStack:
  ...
  {
    title: "WEB APPLICATION WITH ONLINE TELESCOPE VIEWER",
    subTitle: "Team Lead | React.js, Redux, TypeScript",
    projectDescription:
...
- leading team <br>
- constant communication with the client <br>
- front-end architecture design <br>
`,
    team: "8 team members",
    techStack:
      "React.js, Redux, RxJS, ES6, SASS, Bootstrap, JIRA, Jenkins, Webpack",
  },

  {
    title: "WEB APP FOR MANAGING CUSTOM PROJECTS AND TASK FLOW",
    subTitle: "Lead developer | React.js, Redux, Google chrome extension",
    projectDescription:
...
- Creating SPA from scratch <br>
- Creating Google Chrome extension with similar functionality <br>
- Constant communication with Director of Engineering and Product Manager from client side <br>
- Project configuration for production <br>
  `,
    team: "8 team members",
    techStack:
      "React.js, Redux, RxJS, ES6, SASS, Bootstrap, JIRA, Jenkins, Webpack",
...

  {
    ...
    subTitle: "Lead developer | Angular 7, TypeScript, Firebase, Node.js",
    projectDescription:
    ...
    role: "Lead Full-Stack Developer",
    responsibilities: `	- Investigating and implementing front-end technical solutions <br>
- Creating Angular5 application from scratch <br>
- Constant communication with Product owner <br>
- Project configuration for production <br>
  `,
    team: "10 team members",
    techStack:
  ...
  {
    title: "US VISA ASSISTANT WEB APPLICATION",
    subTitle: "Lead developer | Angular 2, Node.js, Express.js",
    projectDescription:
...
- Code review <br>
- Preparing code for Production; <br>
...
`,
  ...
  {
    title: "E-COMMERCE PROJECT",
    subTitle: "Senior developer | React.js, Redux, Node.js, Express.js",
    projectDescription:
...
- Communication with products owners; <br>
- SEO optimizations; <br>
`,
  ...
  {
    title: "CUSTOM APPLICATION MANAGER",
    subTitle: "Lead developer | Angular.js, Firebase, Node.js",
    projectDescription: `The main goal of the application is to assist the process of creating custom applications for artists. Creating custom Collections, uploading images, recording sound. Website scrapping and importing images.
  Integrations with:
...
- Project configuration for production <br>
  ...
  {
    title: "ONBOARDING AND ACCOUNT CREATION SYSTEM",
    subTitle: "Senior developer | React.js",
    projectDescription: `The project’s aim was to create a system for opening bank accounts for different business structures. The product delivers an effective, flexible proposition which will improve the overall customer experience by making day to day banking easier and more accessible across all other products and services. The main requirements are:
  - New customer facing web site for onboarding and account opening; <br>
- Product activation and after-sale care (up to 30 days); <br>
...
- Web application development; <br>
- Implementing accessibility level AA; <br>
- Communication with products owners; <br>
- Issue resolving, support. <br>
  `,
    team: "5-8 team members",
    techStack: "JavaScript (ES2015, JSX), HTML5, CSS3, React, Redux, lodash",
  },

  {
    title: "VINYL RECORDS ONLINE STORE",
    subTitle: "Lead developer | Angular.js, Bootstrap",
    projectDescription:
...
- Designing front-end application architecture; <br>
- Code review; <br>
- Investigating and fixing issues; <br>
- Code refactoring. <br>
  `,
  ...
  {
    title: "SOCIAL ACTIVITIES ANALYZING APPLICATION",
    subTitle: "Angular.js, Bootstrap",
    projectDescription:
...
- Web application development; <br>
- Communication with the product owner and product management team. <br>
  `,
    team: "6 team members",
    techStack:
  ...
  {
    title: "APPLICATION FOR MANAGING INVESTMENTS",
    subTitle: "Angular.js, Bootstrap",
    projectDescription:
...
- Communication with the customer and designers; <br>
- Unit testing; <br>
- Code refactoring; <br>
- Investigating and fixing issues. <br>
  `,
  ...
  {
    title: "APPLICATION FOR MANAGING DENIALS IN INSURANCE SYSTEMS",
    subTitle: "Backbone.js",
    projectDescription:
...
- Development of Web UI; <br>
- Communication with product owner and UX designers; <br>
- Code review; <br>
- Mentoring junior staff. <br>
  `,
    team: "12-20 team members",
    techStack:
      "JavaScript, Backbone.js, jQuery, Jasmine, HTML5, CSS3, Bootstrap, AJAX, Git, Grunt, RequireJS, JIRA",
  },

  {
    title: "WEB HELP DESKS",
    subTitle: "Ext.js",
    projectDescription:
    ...
    responsibilities: `	
- Web application development; <br>
- Fixing and supporting issues; <br>
- Communication with the back-end and QA teams from client side. <br>
- Communication with product owner. <br>
  `,
    team: "12-20 team members",
    techStack:
      "JavaScript, Backbone.js, jQuery, Jasmine, HTML5, CSS3, Bootstrap, AJAX, Git, Grunt, RequireJS, JIRA",
  ...
  {
    title: "E-COMMERCE SOFTWARE PLATFORM",
    subTitle: "Demandware",
    projectDescription:
    ...
    role: "Software Developer",
    responsibilities: `	- Web application development; <br>
- Fixing and supporting issues;`,
    techStack: "JavaScript, jQuery, HTML, CSS, JIRA",
  },
]
